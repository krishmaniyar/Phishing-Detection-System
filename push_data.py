...
class NetworkDataExtract():
    ...
    def cv_to_json_convertor(self, file_path: str) -> list:
        """
        This function converts a CSV file to a list of JSON objects.
        
        file_path: str: The path to the CSV file.
        
        return: list: A list of JSON objects.
        """
        try:
    ...
    def insert_data_mongodb(self, records, database, collection) -> None:
        try:
            ...
            logging.info(f"Data inserted into MongoDB database: {database}, collection: {collection} successfully.")
